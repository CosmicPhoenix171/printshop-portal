    ...
    <Page title={`Order ${order.orderNumber}`} intro={order.modelName}>
      <div className="detail-grid">
        ...
        {isAdmin && <form className="panel form-grid" onSubmit={saveOrderQuote}>
          ...
          <label>Material cost<input name="materialCost" type="number" min="0" step="0.01" defaultValue={(calculatedQuoteMaterialCostCents / 100).toFixed(2)} /><small>Auto-calculated from {order.material} rates including waste allowance; you can override it.</small></label>
